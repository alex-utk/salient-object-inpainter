...
class Dino(nn.Module):
    def __init__(
        ...
        # torch.save(self.student_encoder.module.state_dict(), 'NEW_STUDENT.pt')
...
def main():
    ...
    for dataset in test_datasets:
        ...
        dino.train()
        student_encoder = dino.student_encoder.module
        # dino.eval()
        # dino.student_encoder.eval()
        ...
        for i_test, data_test in tqdm(enumerate(test_salobj_dataloader)):
            ...
            traced_model = torch.jit.trace(student_encoder, inputs_test)
