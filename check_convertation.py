...
def save_output(image_name,pred,d_dir):
    ...
    open_cv_image = np.array(imo)
    np.save(d_dir+imidx+'.npy', open_cv_image)
...
def main():
    ...
    for dataset in test_datasets:
        image_dir = '/mnt/88fdd009-dda3-49d8-9888-cfd9d9d5910a/ITMO/proj_seminar/input_imgs'
        # folder_pred = os.path.join(os.getcwd(), '../testing/','output_' + model_name + '_results' + os.sep)
        
        #! prediction_dir = '/mnt/88fdd009-dda3-49d8-9888-cfd9d9d5910a/ITMO/proj_seminar/output/'
        prediction_dir = '/mnt/88fdd009-dda3-49d8-9888-cfd9d9d5910a/ITMO/proj_seminar/output_NEWEST/'
        ...
        model_dir = '/mnt/88fdd009-dda3-49d8-9888-cfd9d9d5910a/ITMO/proj_seminar/final_patch32_pseudo_dino_edge_pre_trans_u2net/u2net_bce_epoch_139_train_fulldino.pth'
        ...
        student_encoder = torch.jit.load("traced_model.torchscript", map_location=DEVICE)
        ...
        for i_test, data_test in tqdm(enumerate(test_salobj_dataloader)):
            ...
            with torch.inference_mode():
                ...
                d1 = student_encoder(inputs_test)[0]
